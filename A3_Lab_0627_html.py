...
# Lcs['조건문Pandas'] = np.where(Lcs['검사명'] == 'Albumin','DDD','FFF')

df.loc[df['검사명'] != 'Albumin', '조건문Pandas'] = ('66666')
df.loc[df['검사명'] == 'Albumin', '조건문Pandas'] = ('11111')
...
#         charact_lab(i)
#
# Lcs.to_string('C:/GDSRC/Result/RC_result_file.txt', encoding='utf-8')
